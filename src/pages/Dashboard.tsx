...
const Dashboard = () => {
  ...
  return (   <><div className="roundedbox bg-black w-[85%]  m-[3rem] ml-[2rem] top-[-2rem] md:hidden flex flex-row fixed   justify-between px-6">
        <button data-drawer-target="default-sidebar" onClick={()=>{setSideBar(!SideBar)}} data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center mb-[] p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden  ">
