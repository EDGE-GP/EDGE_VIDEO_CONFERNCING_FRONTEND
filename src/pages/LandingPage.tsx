...
const LandingPage = () => {
  ...
  return (
    <div className="relative ">
      ...
      <div
        ref={rootElement}
        className="pt-[4rem]  flex container bg-white   px-24  justify-between background-pattern  border-[#212121] relative w-screen h-screen  items-center"
      >
      ...
      <motion.div
        ...
        className="px-24 pt-[3rem]  border-[#212121] relative w-screen  justify-between "
      >
      ...
      >
        ...
        <div className=" w-full ">
          <div className="flex h-[70vh] px-24 gap-x-20 justify-between items-center w-full">
      ...
      >
        ...
        <div className="w-full px-24">
          <div className="gap-x-20 flex justify-between items-start  w-full ">
            <div className="relative w-full">
              <h1 className="text-[4rem]  abel max-w-[80%] leading-[5.5rem]">
                User Feedback
              </h1>
              <h3 className="abel text-xl max-w-[70%]  text-[#212121]">
              ...
              <div className="flex w-full justify-between gap-x- mt-8 items-center">
                <div className="relative  w-[40%]">
                  <span className="bottom-3 rotate-180 left-0 absolute">
                    <svg
                      width="60"
                      height="60"
                      viewBox="0 0 75 76"
                ...
                <div className="w-[45rem] h-[28rem] grid grid-cols-3 grid-rows-2">
                  <div className="col-span-1 flex items-start flex-col px-4 py-5 row-span-1 border-[#212121] border-l-2 border-t-2 rounded-tl-[20px] ">
                  ...
                  <div
                    className={`px-4 py-5 col-span-1 row-span-1 border-[#212121] border-t-2  border-l-2 border-t-2items-start  flex flex-col`}
                  >
                    <div className="flex  items-center gap-x-2">
                      <div className="w-8 h-8 rounded-full">
                        <img
                  ...
                  <div
                    className={`col-span-1 px-4 py-5 flex flex-col row-span-1 border-[#212121] bg-[#212121] text-white relative  border-t-2 border-l-2 border-r-2 rounded-tr-[20px]`}
                  >
                    <span className="absolute top-[-3rem] rotate- right-[-3rem] ">
                      <svg
                        width="61"
                  ...
                  <div
                    className={`col-span-1 px-4 py-5 flex flex-col row-span-1 border-[#212121]  border-l-2 border-b-2 border-t-2 rounded-bl-[20px] bg-[#]`}
                  >
                    <div className="flex  items-center gap-x-2">
                      <div className="w-8 h-8 rounded-full">
                        <img
                  ...
                  <div
                    className={`col-span-1 px-4 py-5 flex flex-col  row-span-1 border-[#212121] bg-[#212121] text-white border-l-2 border-t-2 border-b-2`}
                  >
                    <div className="flex  items-center gap-x-2">
                      <div className="w-8 h-8 rounded-full">
                        <img
                  ...
                  <div
                    className={`col-span-1 px-4 py-5 flex flex-col row-span-1  border-[#212121] border-l-2 rounded-br-[20px] `}
                  >
      ...
      <motion.div
        ...
        className="  pt-[3rem] flex flex-col justify-center w-screen  relative"
      >
        <div className="px-24 pb-[3rem]">
          {/*  */}
          ...
          <div className="gap-x-20 flex justify-between items-center  w-full ">
            <div className="relative w-1/2 ">
              ...
              <h3 className="text-[1rem] font-semibold abel max-w-[40%]">
                Get Started
              </h3>
              <h1 className="text-[4rem] abel max-w-[80%] leading-[5.5rem]">
                Let's Start The First Conversation.
              </h1>
              <h1 className="text-[3rem] abel  ">You are only one sign away</h1>
              <button
                onMouseEnter={() => {
                  setStartOnHover(true);
                }}
        ...
        <div className="h-[5rem] font-[500] w-[95%] black-gradient rounded-tr-[20px] flex px-[4.5rem] justify-between text-white items-center relative">
