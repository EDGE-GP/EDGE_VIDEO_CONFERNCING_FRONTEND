...
const Settings = () => {
  ...
  const [toggleImageSelection, setToggleImageSelection] =
  ...
  useEffect(() => {
    ...
    if (user.photo) {
      setToggleImageSelection(false);
    } else {
      setToggleImageSelection(true);
    }
  }, [user]);
  useEffect(() => {
    const isDisabled =
        ...
        <div className="w-full flex justify-center items-center">
          <div className="max-w-[80%] h-[33.25rem] px-12 mt-6 flex flex-col justify-between">
            <div className="w-full">
              ...
              <div className="w-full flex flex-col gap-y-6">
                ...
                <div className="flex justify-end pr-1 w-fulll items-start gap-x-12">
                  <button className="text-[#151515] font-semibold abel">
            ...
            <div className="w-full gap-x-4 flex justify-end h-[4.5rem] items-center">
              <button className="flex gap-x-1 items-center abel h-[2.375rem]   justify-center text-center transition-all text-[#151515] border-[1px] border-[#E0E0E0] bg-transparent duration-200 rounded-[8px] drop-shadow-md px-6">
                Reset default
              </button>
              <button
                ...
                } duration-200 rounded-[8px] drop-shadow-md px-6`}
              >
                Change Personal Information
              </button>
            </div>
