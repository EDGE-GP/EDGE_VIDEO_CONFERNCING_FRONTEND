...
const Networking = () => {
  return (
    <div className=" h-full flex flex-col ml-[17.5rem] rounded-2xl  mr-[2rem] ">
      <div className="h-[21.25rem] w-full grid grid-cols-6 gap-x-6 ">
        {/* meeting header */}
        <div className=" rounded-2xl w-full col-span-4 h-full bg-white card-shadow px-4 py-2 ">
          <h3 className="abel text-[1.3rem] mb-2">Meeting Invitations</h3>
          <div className="flex flex-col gap-y-2 h-[17.75em] overflow-y-scroll px-2">
                ...
                <div className="flex gap-x-2 items-center">
                  ...
                  <div className="flex gap-x- items-center">
                    ...
                    <h1 className="abel text-lg">
                      Thursday, 11<sub className="align-super">th</sub> April
                      2024
                    </h1>
                  </div>
                </div>
        ...
        <div className="w-full col-span-2 h-full px-4 py-2 rounded-2xl card-shadow bg-white">
          <h3 className="abel text-[1.3rem] mb-2">Notifications</h3>
          <div className="flex flex-col gap-y-2 h-[17.75em] overflow-y-scroll">
            <div className="flex flex-col w-full px-3 py-3 rounded-2xl bg-[#F7F7F7]">
      ...
      <div className="h-[21.25rem] grid grid-cols-6 justify-between items-center gap-x-6 mt-4 rounded-2xl w-full ">
        <div className="col-span-2 w-full px-4 py-2 rounded-2xl h-full bg-white card-shadow">
          <h3 className="abel text-[1.3rem] mb-2">Friend Requests</h3>
          <div className="flex flex-col px-2 gap-y-2 h-[17.75em] overflow-y-scroll">
        ...
        <div className="col-span-2 w-full px-4 py-2 rounded-2xl h-full bg-white card-shadow">
          <h3 className="abel text-[1.3rem] mb-2">Friends</h3>
          <div className="flex flex-col px-2 gap-y-2 h-[17.75em] overflow-y-scroll">
            <div className="flex justify-between ">
              <div className="flex justify-start items-center gap-x-2">
                <img
        ...
        <div className=" col-span-2 w-full h-full flex flex-col justify-between bg-white card-shadow rounded-2xl px-4 py-2">
