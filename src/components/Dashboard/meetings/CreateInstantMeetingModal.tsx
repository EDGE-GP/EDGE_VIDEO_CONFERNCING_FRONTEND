...
const CreateInstantMeetingModal = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[50rem] gap-y-3 bg-white">
        <DialogHeader>
            ...
            <div className="w-full flex justify-between  gap-x-8">
                    ...
                    <div className="flex flex-col mb-3 ">
                      ...
                      <div className="w-full flex justify-between items-end">
                        <h3 className="abel text-[0.9rem] w-[85%]">
                          Every interpreted word/sign will be saved as a message
                          in your converstations
                        </h3>
                        <div>
                          <Switch
              ...
              <div className="w-1/2 h-full flex flex-col gap-y-4">
                <div className="flex flex-col">
                  ...
                  <div className="w-full flex justify-between items-end">
                    <h3 className="abel text-[0.9rem] w-[85%] ">
                      Every interpreted word will be displayed to deaf users via
                      a 3d-model sign gestures
                    </h3>
                    <div>
                      <Switch
