...
const Sidebar = () => {
  ...
  return (
    <div className="text-white px-4 py-4 h-[92%] w-[15rem] rounded-3xl fixed  bg-[#151515] gap-y-2 flex flex-col justify-between ">
      <div className="flex flex-col gap-y-2">
        <div className="w-full ">
          <img src={edgeLogo} className="w-full h-[rem]" alt="" />
        </div>
        <Link
          to="/dashboard/meetings"
          className="w-full flex justify-center items-center mt-3 cursor-pointer "
        >
          <div
